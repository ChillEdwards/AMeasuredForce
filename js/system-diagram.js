/* System Diagram — vanilla JS implementation
   ...
   Adapted from the design handoff: fonts swapped to AMF stack
   (Playfair Display + Inter). Bails silently if #system-svg
   is not present, so it's safe to include on any page.
   ---------------------------------------------------------------- */
...
(function () {
  ...
  obs.observe(document.querySelector('.system-diagram .diagram'));
